...
describe('Drinks', () => {
    ...
    // Tests that the function fetches and renders a list of drink categories
    it('should fetch and render a list of drink categories', async () => {
      // Mock the fetch function to return a response with category data
