...
describe('Drinks', () => {
    ...
    // Tests that the function fetches and renders a list of drinks
    it('should fetch and render a list of drinks', async () => {
      // Mock the fetch function to return a response with drink data
      // Render the Drinks component
      // Wait for the drinks to be fetched and rendered
      // Assert that the drinks are rendered
    });
});
