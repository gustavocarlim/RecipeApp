...
describe('Drinks', () => {
    ...
    // Tests that the function clears the category filter and renders all drinks
    it('should clear the category filter and render all drinks', async () => {
      // Mock the fetch function to return a response with all drink data
      // Render the Drinks component
      // Select a category
      // Clear the category filter
      // Wait for all drinks to be rendered
      // Assert that all drinks are rendered
    });
});
