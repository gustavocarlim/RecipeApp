  ...
  drinks: [
    {
      ...
      of the glass with ginger ale and thats all there is to it. You now have
      a your very own GG.`,
      ...
      strInstructionsIT: `Versare il liquore Galliano su ghiaccio. Riempi il 
      resto del bicchiere con ginger ale e questo è tutto. Ora hai il tuo GG personale.`,
